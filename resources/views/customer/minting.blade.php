...
<div class="mx-5 mt-3 text-gray-200 rounded-xl bg-gray-700">
    ...
    <div class="bg-gray-700 rounded-b-xl mt-2 pt-5 pb-2">
        ...
        <div class="flex justify-center ">
            ...
            <input type="text" class="text-yellow-500 bg-gray-500 text-center" disabled value="{{ number_format($minting) }}" id="val-minting">
        </div>
        <div class="text-center capitalize mt-2 ">Min Claim : 1 XWDOGE</div>
        <div class="text-center capitalize mt-2 text-yellow-500">Minted results can be claimed at any time</div>
        <div class="text-center capitalize mt-2 text-red-500">Claim Fee 0.1 DOGE</div>
        <div class="px-3 mt-4 grid grid-cols-2 gap-4">
            <button class="w-full p-2 bg-yellow-500 rounded-xl font-black mx-auto" id="claim_token">Claim</button>
...
<div class="mt-5 text-gray-100 rounded-xl bg-gray-700 mx-5">
    ...
    <div class="rounded-xl bg-gray-900 mx-auto">
        ...
        <div class="flex justify-center items-center">
            <button class="bg-yellow-500 w-fit p-2 mx-auto rounded-xl mt-5 btn-cpy flex" data-link="{{ route('register',['reff'=> $users->username]) }}">
    ...
    <div class="text-gray-300">
        ...
        <div class="flex justify-center mt-2">
            <button class="text-gray-300 bg-yellow-500 w-fit p-2 rounded-xl font-black" id="claim_bonus">Claim</button>
        </div>
    </div>
